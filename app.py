...
try:
    ...
    ax2.figtext(0, 0, "Fuente: Elaboración propia en base a datos de INDEC, IBGE, entre otros.", fontsize=9, color='gray')
    ax.grid(True)
    fig2.tight_layout()
    st.pyplot(fig2)
    ...
    ax1.figtext(0, 0, "Fuente: Elaboración propia en base a datos de INDEC.", fontsize=9, color='gray')
    ax1.legend()
    ax1.grid(True)
    st.pyplot(fig1)
    ...
    ax2.figtext(0, 0, "Fuente: Elaboración propia en base a datos de INDEC.", fontsize=9, color='gray')
    ...
    ax5.figtext(0, 0, "Fuente: Elaboración propia en base a datos de INDEC.", fontsize=9, color='gray')
    st.pyplot(fig5)
